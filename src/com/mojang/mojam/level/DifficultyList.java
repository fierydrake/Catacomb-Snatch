...
public class DifficultyList {
	...
	private static void createDifficultyList() {
		...
		Difficulties.add(new DifficultyInformation("diffselect.easy", .5f, .5f, 1.5f, .5f, 0));
		Difficulties.add(new DifficultyInformation("diffselect.normal", 1, 1, 1, 1, 1));
		Difficulties.add(new DifficultyInformation("diffselect.hard", 3, 3, .5f, 1.5f, 2));
		Difficulties.add(new DifficultyInformation("diffselect.nightmare", 6, 5, .25f, 2.5f, 3));
	}
